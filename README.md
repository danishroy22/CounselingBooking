...
1. Configure Firebase credentials in `config/env-config.js`
2. Set up Firebase Realtime Database rules (see `firebase.rules.json`)
...
Set up your Firebase project and add credentials to `config/env-config.js`:
